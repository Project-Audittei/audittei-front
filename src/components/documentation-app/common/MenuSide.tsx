import { Home, Type, LayoutGrid, Brush, MousePointer2, Component, TextCursorInput, BookOpen, Award, BetweenHorizonalStart, Navigation, Info, TriangleAlert } from "lucide-react";
